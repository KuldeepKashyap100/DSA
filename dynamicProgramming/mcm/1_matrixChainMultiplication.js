 ...
 * affects the number of simple arithmetic operations needed to compute the product, 
 * or the efficiency. For example, suppose A is a 10 × 30 matrix, B is a 30 × 5 matrix, and C is a 5 × 60 matrix. Then,  
 * 
 * (AB)C = (10×30×5) + (10×5×60) = 1500 + 3000 = 4500 operations
 * A(BC) = (10×30×60) + (30×5×60) = 9000 + 18000 = 27000 operations.
 * 
...
const matrixChainMultiplicationBottomUp = (arr) => {
    ...
    for(let matrixChainLength = 2; matrixChainLength <= numberOfMatrix; matrixChainLength++) {
        // below loop is for number of combinations possible for length matrixChainLength(
